...
export const copy = {
  vi: {
    ...
    createSyncRoom: 'Chia sẻ phòng (đồng bộ)',
    syncRoomCode: (code: string) => `Mã phòng: ${code}`,
    copyRoomLink: 'Copy link phòng',
    roomLinkCopied: 'Đã copy link phòng.',
    joinRoomLabel: 'Có mã phòng?',
    joinRoomPlaceholder: 'Nhập mã phòng',
    joinRoomButton: 'Vào phòng',
    joinRoomError: 'Không tìm thấy phòng với mã này.',
    syncErrorNotice: 'Mất kết nối đồng bộ — điểm chưa lưu lên phòng chung.',
    viewOnlyNotice: 'Bạn đang xem — chỉ host mới được nhập điểm.',
    leaveRoom: 'Rời phòng',
    liveSyncLabel: 'Đang đồng bộ',
  ...
  en: {
    ...
    createSyncRoom: 'Share room (live sync)',
    syncRoomCode: (code: string) => `Room code: ${code}`,
    copyRoomLink: 'Copy room link',
    roomLinkCopied: 'Room link copied.',
    joinRoomLabel: 'Have a room code?',
    joinRoomPlaceholder: 'Enter room code',
    joinRoomButton: 'Join room',
    joinRoomError: 'No room found with this code.',
    syncErrorNotice: 'Sync connection lost — scores are not saved to the shared room.',
    viewOnlyNotice: 'You are viewing — only the host can enter scores.',
    leaveRoom: 'Leave room',
    liveSyncLabel: 'Live syncing',
